/**********************************************************************************************************
  ...
  JUN/2022 - Alternative Version - Support to OLED 1.3" display SH1106, CW Keying input, and CLK1 and CLK2
  outputs activated for 2 intermediate frequencies of USB/LSB - Contribution of Mr. Pablo Woiz (LU1AGH)
***********************************************************************************************************/
...
void setstep() {
  switch (stp) {
    ...
    case 4: stp = 1; fstep = 100000; break;
      //case 5: stp = 1; fstep = 1000000; break;
...
void inc_preset() {
  count++;
  if (count > 5) count = 1; //cantidad de bandas
  bandpresets();
  delay(50);
}
...
void bandpresets() {
  switch (count)  {
    //case 1: freq = 500; tunegen(); break;
    case 1: freq = 3650000; break;
    case 2: freq = 7100000; break;
    case 3: freq = 14175000; break;
    case 4: freq = 28900000; break;
    case 5: freq = 144000000; break;
...
void layout() {
  ...
  if (stp == 2) display.print("100Hz"); if (stp == 3) display.print("1KHz"); if (stp == 4) display.print("10kHz");
  if (stp == 5) display.print("100kz"); if (stp == 6) display.print("1Mhz"); if (stp == 1) display.print("100kz");
  display.setTextSize(1);
...
void bandlist() {
  ...
  if (count == 1) display.print("80m"); if (count == 2) display.print("40m"); if (count == 3) display.print("20m"); if (count == 4) display.print("10m");
  if (count == 5) display.print("2m"); if (count == 6) display.print("2m"); if (count == 7) display.print("40m"); if (count == 8) display.print("31m");
...
void statup_text() {
  ...
  display.print("JCR RADIO - Alternative Version 2.0");
